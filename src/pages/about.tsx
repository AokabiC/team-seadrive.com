      ...
      <section>
        <dl>
          ...
          <dd>
            <Ul>
              <li>
                2020/01 : DISCO presents ディスカバリーチャンネル
                コードコンテスト2020本戦 出場
              </li>
              <li>
                2019/11 : ACM-ICPC Asia Yokohama Regional 2019 16位
                (Aobayama_dropout)
              </li>
              <li>
                2019/11 : ACM-ICPC Asia Bangkok Regional 2019 19位
                (Aobayama_dropout)
              </li>
              ...
              <li>
                2018/12 : ACM-ICPC Asia Yokohama Regional 2018 21位
                (Aobayama_dropout)
              </li>
          ...
          <dd>
            <Ul>
              <li>
                2018/06 : SOUND VOLTEX FLOOR 東方永夜抄アピールカードコンテスト
                採用
              </li>
            </Ul>
          </dd>
